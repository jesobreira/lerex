...
/**
 * Creates an instance of SwapXRESTB2BModelsUserRestAddPolicyHolderModel
 */
class SwapXRESTB2BModelsUserRestAddPolicyHolderModel extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.insurancePolicyList = this.constructor.getValue(obj.insurancePolicyList);
        this.verificationCode = this.constructor.getValue(obj.verificationCode);
        ...
        return super.mappingInfo().concat([
            {
                ...
                realName: 'insurancePolicyList',
                array: true,
                type: 'SwapXRESTB2BModelsUserRestInsurancePolicy',
            },
            { name: 'verificationCode', realName: 'verificationCode' },
...
module.exports = SwapXRESTB2BModelsUserRestAddPolicyHolderModel;
